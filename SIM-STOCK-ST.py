...
Del.set_index('Part_No',inplace=True)
...
Delm=pd.merge(MCm,Del,on='Part_No',how='left')
...
STbf['BM_STOCK']=(STbf['BM']+STbf['BM-Pcs'])-(STbf['FG0-Pcs'])
BM_STOCK=STbf['BM_STOCK']
#st.subheader('BM Stock Balance')
#st.write(BM_STOCK)

STbf['FG0_STOCK']=(STbf['FG0']+STbf['FG0-Pcs'])-(STbf['FG1-Pcs'])
